...
class AssistantAgent:
    ...
    async def process_prompt(self, user_name: str, user_id: str, prompt: str) -> str:
        ...
        run = self.client.beta.threads.runs.create(
            ...
            instructions=f"Please address the user as {user_name}. The user has a premium account. Be assertive, accurate, and polite. Ask if the user has further questions. Do not provide explanations for the answers."
        ...
        while True:
            ...
            if run.status == "completed":
                ...
                messages = self.client.beta.threads.messages.list(
                    thread_id=thread.id)
                output_messages = self.process_messages(user_name, messages)
                break
            ...
            for item in message.content:
                ...
                if isinstance(item, MessageContentText):
                    if message.role == "user":
                        ...
                        output_message += item.text.value
                    ...
                    # Display image
                    image.show()
                    output_message += "An image was generated\n"
